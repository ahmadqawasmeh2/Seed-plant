...
<div class="br-mainpanel">
  ...
  <div class="br-pagebody">
    <div class="br-section-wrapper">
      ...
      <form action="{{route('admin.admin.add_product')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-layout form-layout-1">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" wrap="off" cols="30" rows="5" style="resize: none;" name="desc"></textarea>
          </div>
